...
protected: 
	...
	XMFLOAT3 m_xmf3Right; XMFLOAT3 m_xmf3Up; XMFLOAT3 m_xmf3Look;
	...
	float           m_fFriction;
	//플레이어의 위치가 바뀔 때마다 호출되는OnPlayerUpdateCallback() 함수에서 사용하는 데이터이다.
...
public:
	...
	현 재 플레이어의 위치에서 xmf3Position 방향으로의 벡터가 된다.
