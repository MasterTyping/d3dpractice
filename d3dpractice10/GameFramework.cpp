...
void GameFramework::ProcessInput()
{
	...
	float cxDelta = 0.0f, cyDelta = 0.0f; POINT ptCursorPos;
...
void GameFramework::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	...
	{ 
		case WM_KEYUP:
			...
			{ 
				case VK_F1:
					if (m_pPlayer) m_pPlayer->ChangeCamera((1), m_GameTimer.GetTimeElapsed());
					break;
				case VK_F2:
					if (m_pPlayer) m_pPlayer->ChangeCamera((2), m_GameTimer.GetTimeElapsed());
					break;
				case VK_F3:
					if (m_pPlayer) m_pPlayer->ChangeCamera((3), m_GameTimer.GetTimeElapsed());
					break;
