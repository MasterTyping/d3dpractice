...
GameFramework::GameFramework()
{
	...
	_tcscpy_s(m_pszFrameRate, _T("Triangle ("));
	m_pdxgiFactory = NULL;
...
void GameFramework::CreateDirect3DDevice()
{
	...
	m_d3dViewport.TopLeftX = 0; m_d3dViewport.TopLeftY = 0;
...
void GameFramework::FrameAdvance()
{
	...
	d3dResourceBarrier.Transition.StateAfter = D3D12_RESOURCE_STATE_PRESENT; d3dResourceBarrier.Transition.Subresource = D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES; m_pd3dCommandList->ResourceBarrier(1, &d3dResourceBarrier);
